...
Vue.mixin({
    ...
    methods: {
        ...
        fadeInOut: function(obj,trigger,ClassName) {
            $(window).scroll(function() {
                if($("html, body").scrollTop() > $(trigger).offset().top-200){
        ...
        timeover: function(day) {
            return new Promise(function(resolve, reject){
                var endDay = new Date(day).getTime();
    ...
    mounted: function () {
        ...
        if(window.innerWidth < 900) {
            vm.linefriend = "line://app/1630186793-lP9Aewmr?flag=ghost_temp"
        } else {
            vm.linefriend = "http://line.naver.jp/ti/p/%40carrefourtw"
        }
    }
})
