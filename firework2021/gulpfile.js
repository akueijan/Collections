...
var isDev, destPath,
    ...
    // pordClientid = "1515344613",
    // devClientid = "1511930966",
    // pordRedirecturl = "https://richart.tw/TSDIB_RichartWeb/RC08/Line10",
    // devRedirecturl = "https://tsdib-test.taishinbank.com.tw/TSDIB_RichartWeb_line/RC08/Line10",
    jsFolder = "js/",
    ...
    return gulp.src(['src/**/*.pug','!src/**/_*.pug', 'src/*.jade', '!src/_*.jade'])
        ...
        .pipe(pug({
            ...
            locals: {
                ...
                // clientId: (isDev) ? devClientid : pordClientid,
                // redirectUrl: (isDev) ? devRedirecturl : pordRedirecturl,
                jsFolder: jsFolder,
                dev_mode: isDev,
                timestamp: Date.now()
            }
